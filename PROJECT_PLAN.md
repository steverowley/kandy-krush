...
| B6 | Refactor `main.js` + hook bus | 🚧 in progress — bus + canonical emit points shipped (#278). Full module split / inline-effect migration still ahead. |
...
| B12 | Tests (Vitest → node:test) | ✅ shipped (52 tests) | #268 / #278 / #279 |
